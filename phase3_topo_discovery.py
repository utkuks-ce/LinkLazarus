...
class LLDPPathController(app_manager.RyuApp):
    ...
    def add_arp_flood_rule(self, dp, priority=1):
        ...
        dp.send_msg(mod)
        self.logger.info(f"[FEATURES] Low-priority ARP flood rule installed on DPID={dp.id}")
